...
public class MultiSence_WorkSpace_Datacollection_Myopenissues extends TestBase {
	
	Logger log = LogManager.getLogger(MultiSence_WorkSpace_Datacollection_Myopenissues.class);	             
	...
	{	
        ...
        Multisense();
        Workspace();
		dataCollectionIssuesPage.navigateTo_MultiSenceWorkspaceDatacollection_MyopenIssues();
	}
	@Test(priority = 1)
