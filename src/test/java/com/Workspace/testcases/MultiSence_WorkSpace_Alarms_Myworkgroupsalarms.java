...
public class MultiSence_WorkSpace_Alarms_Myworkgroupsalarms extends TestBase {
	
	Logger log = LogManager.getLogger(MultiSence_WorkSpace_Alarms_Myworkgroupsalarms.class);	
	...
	{	
		...
		Multisense();
	    Workspace();
		alarmsSelectionPage.navigateToMyworkgroupsalarms();
	}
	@Test(priority=1)
