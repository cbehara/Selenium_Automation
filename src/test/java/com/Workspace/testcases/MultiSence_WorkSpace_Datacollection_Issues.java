...
public class MultiSence_WorkSpace_Datacollection_Issues extends TestBase {

	Logger log = LogManager.getLogger(MultiSence_WorkSpace_Datacollection_Issues.class);
	...
	public void TC001_NavigateToIssuesPage() throws IOException, InterruptedException {
		...
		Multisense();
		Workspace();
		dataCollectionIssuesPage.navigateTo_MultiSenceWorkspaceDatacollection_Issues();
	}
