...
public class MultiSence_WorkSpace_Alarms_Alarms extends TestBase {
              
              Logger log = LogManager.getLogger(MultiSence_WorkSpace_Alarms_Alarms.class);              
             ...
             public void TC001_NavigateToAlarmsPage() throws IOException, InterruptedException 
              {             
                             ...
                             Multisense();
                             Workspace();
                             alarmsSelectionPage.navigateToAlarms();
               }
              @Test(priority=1)
             ...
             @Test(priority=7)
              ...
              @Test(priority=10)
              public void TC011_ValidateAlarmPriorityFilter() 
              {
            	  			alarmsSelectionPage.validatePriorityFilter();
              }
              @Test(priority=11)
              public void TC012_ValidateBulkAction() throws IOException 
              {
            	  			alarmsSelectionPage.validateBulkaction();
              }
