...
public class DataCollectionIssuesTest extends TestBase {
	...
	@Test (priority = 1, description = "Verify Navigation to Workspace DC Issues page")	
	public void verifyNavigationToDCIssuesPage() 
	{			
		DataCollectionIssuesPage = new DataCollectionIssuesPage();
		
		reporterLog("Starting testcase Verify Navigation to Workspace DC Issues page");
		
		log.info("************* starting test case : Verify Navigation to Workspace DC Issues page **************");

		log.info("Asserting DC Issues page title");
		
		String expectedPageTitle = "Data collection";
		
		WebElement eleActualPageTitle = DriverUtility.getDriver().findElement(By.xpath(prop.getProperty("ConnexoWorkspace_DVI_VerifyDataCollection")));
		...
		WebElement iss= DriverUtility.getDriver().findElement(By.xpath(prop.getProperty("ConnexoWorkSpace_DC_issues")));
	...
	@Test (priority = 26, description = "Verify Navigation to Workspace DC open issues page",enabled = true)	
	...
	@Test (priority = 49, description = "Verify Navigation to Workspace DC my wrkgrp issues page",enabled = true)	
	public void NavigationToDCMwrkgrpIssuesPage() 
