...
public class MultiSence_WorkSpace_Issues_Myworkgroupsissues extends TestBase {
	
	Logger log = LogManager.getLogger(MultiSence_WorkSpace_Issues_Myworkgroupsissues.class);	             
	...
	{	
        ...
        Multisense();
        Workspace();
        issuesSelectionPage.navigateTo_MultiSenceWorkspaceissues_Myworkgroupsissues();
	}
	@Test(priority = 1)
